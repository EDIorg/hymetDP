...
#' @param QualifierCode (character) Column in \code{L0_flat} containing the code to indicate a given data qualifier.
#' @param QualifierDescription (character) Column in \code{L0_flat} containing the text of the data qualifying comment, e.g., low battery voltage on sensor.
#'
