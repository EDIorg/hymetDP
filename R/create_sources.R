...
#' @param Organization (character) Column in \code{L0_flat} containing the name
#'   of the organization that collected the data.
#' @param SourceDescription (character) Column in \code{L0_flat} containing the
#'   full text description of the source of the data.
#' @param SourceLink (character) Column in \code{L0_flat} containing the link to
#'   the original data file of the data source.
#' @param ContactName (character) Column in \code{L0_flat} containing the name
#'   of the contact person for the data source.
#' @param Phone (character) Column in \code{L0_flat} containing the phone number
#'   for the contact person.
#' @param Email (character) Column in \code{L0_flat} containing the email
#'   address for the contact person.
#' @param Address (character) Column in \code{L0_flat} containing the street
#'   address for the contact person.
#' @param City (character) Column in \code{L0_flat} containing the city in which
#'   the contact person is located.
#' @param State (character) Column in \code{L0_flat} containing the state in
#'   which the contact person is located.
#' @param ZipCode (character) Column in \code{L0_flat} containing the US Zip
#'   Code or country postal code.
#' @param Citation (character) Column in \code{L0_flat} containing the Text
#'   string that gives the citation to be used when the data from each source
#'   are referenced.
#'
