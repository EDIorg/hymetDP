...
#' @param QualityControlLevelCode (character) Column in \code{L0_flat} containing the code used to identify the level of quality control to which data values have been subjected.
#' @param Definition (character) Column in \code{L0_flat} containing the definition of Quality Control Level. Examples: Raw Data, Quality Controlled Data. This is not to be confused with data qualifiers.
#' @param Explanation (character) Column in \code{L0_flat} containing the explanation of Quality Control Level.
#'
